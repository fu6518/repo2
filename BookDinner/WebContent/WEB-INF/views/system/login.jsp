...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title>外卖订餐系统后台管理员</title>
  <meta name="description" content="particles.js is a lightweight JavaScript library for creating particles.">
  <meta name="author" content="Vincent Garreau">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
  <link rel="stylesheet" media="screen" href="${pageContext.servletContext.contextPath}/resources/admin/login/css/style.css">
  <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/resources/admin/login/css/reset.css">
<body>
...
<!-- scripts -->
<script src="${pageContext.servletContext.contextPath}/resources/admin/login/js/particles.min.js"></script>
<script src="${pageContext.servletContext.contextPath}/resources/admin/login/js/app.js"></script>
<script src="${pageContext.servletContext.contextPath}/resources/admin/login/js/jquery-1.8.0.min.js"></script>
